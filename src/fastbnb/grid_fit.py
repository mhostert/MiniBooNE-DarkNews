                    ...
                    for k_x in range(self.grid_params["x_points"]):
                        ...
                        if on_shell:
                            df_decay = av.select_MB_decay_expo_prob(
                                df,
                                coupling_factor=self.v4i(umu4_bf) / self.v4i_def,
                                l_decay_proper_cm=decay_l,
                            )
                        else:
                            df_decay = av.select_MB_decay_expo_prob(
